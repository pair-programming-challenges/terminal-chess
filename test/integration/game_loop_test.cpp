...
TEST(GameLoop, StalematePosition) {
  ...
  // a8: not attacked. b8: covered by Qa6? Qa6 on a6, b8 is not on any line from a6 unless diagonal. a6 to b7 is diagonal. a6 to b8 is NOT (that would be knight move). So b8 might be free.
  // Hmm, this isn't clearly stalemate. Let me use a known one.
  //
  // Known stalemate: White Kc6, Qd6. Black Ka7. Black to move.
  // Ka7 options: a8(Qd6 covers a-file? No, Qd6 is on d6. Rook-like: d1-d8 and a6-h6. Bishop-like: c5,b4,a3 and e5,f4,g3,h2 and c7,b8 and e7,f8.)
  // So Qd6 covers: rank 6, file d, diag c5-a3, diag e7-f8, diag c7-b8, diag e5-h2.
  ...
  // g8 covered by Kf7. g7 covered by Kf7 and Qg6. So all squares covered. Is h8 in check? Qg6 to h8: no (would need to be on same file/rank/diag). g6-h7 is one diagonal step, g6-h8 is a knight move. Kf7 doesn't reach h8.
  // So Kh8 is NOT in check. No legal moves. STALEMATE. But wait, can I verify g8 is really covered?
  // Qg6: covers g7,g8 (along g-file). Yes. And Kf7 covers g8 too. All exits blocked.
  // So the position is: Black Kh8, White Kf7 Qg6, Black to move = stalemate.
